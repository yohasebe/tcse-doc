...
**1,167 constructions** with multiple usage instances in the TCSE database are collected. They are organized into six categories and range from fixed expressions to partially schematic patterns.
...
![Filtering constructions by keyword "wish"](images/15.png)
...
![Construction detail with speaker icon for text-to-speech](images/16.png)
