...
TCSEデータベースには、複数の用例を持つ **1,160件の構文・熟語** が収録されています。構文文法（Construction Grammar; Goldberg 1995, 2006）に基づき、完全に固定された表現から部分的にスキーマ的なパターンまでの連続体を6つのカテゴリでカバーしています。英語の学習者と教育者、および言語研究者にとって有用なリストです。
