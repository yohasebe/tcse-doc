...
Hasebe (2015) および長谷部 (2018) をご引用ください。コーパス規模やバージョンについては、執筆当時のシステムを記述している論文中の数値ではなく、[ドキュメントのトップページ](index.md#_1)に表示されている現在の値をご参照ください。文献情報と詳しい案内は [TCSEの引用について](index.md#tcse_1) をご覧ください。
